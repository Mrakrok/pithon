...
ram=LabelFrame(hlavni,text="Výpočet funkčmí hodnoty",bd=2,relief="ridge",padx=10,pady=10)
...
vypocet_fce=Button(ram,text="Proveď výpočet",font="Calibri 10 bold",command=Vyp_fce)
vypocet_fce.grid(row=1,column=1,rowspan=5,sticky=S+N,padx=5,pady=5)

vysledek=Label(ram,text="Výsledek",font="Calibri 12",bg="lightblue")
vysledek.grid(row=6,columnspan=2,sticky=E+W,padx=5,pady=5)
